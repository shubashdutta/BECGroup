...
const StudentVerfiy: FC<studentProps> = ({ student, fun }) => {
  ...
  const handleVerfiyStudnt = async () => {
    ...
    fromData.append("verification", JSON.stringify(payload));
    ...
    try {
      const res: any = await apiRequest.post("api/student/verify", fromData);
